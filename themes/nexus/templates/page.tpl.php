...
<div id="page">
  ...
  <div id="slidebox" class="flexslider">
    <ul class="slides">
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'nexus') . '/images/Battlestar-Symbol.jpg'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'nexus') . '/images/Battlestar-galactica-w.jpg'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'nexus') . '/images/galactica.jpg'; ?>"/>
